...
- [ ] iOS の PDF が US レター（612×792pt）で出力されていた（expo-print iOS は @page を無視）。A4 と向きを明示して修正。余白（@page margin の効き）はシミュレータで実測して確定
- [ ] iOS の PDF 余白を実測して `margins` を決める。縦横それぞれ 1・3・4・10・20 種目、チェック表 ON/OFF で、MediaBox・ページ数・余白・欠けや空白ページを確認する
